                    ...
                    <div class="d-help-login">
                        ...
                        <form method="post" id="commentform1" class="d-help-comment-form-login">
                            ...
                            <div class="d-help-commet-field">
                                <label>用户名</label>
                                <input placeholder="   请输入用户名" name="User[name]" type="text" value="" data-default="Name*" autocomplete="off" size="30" required>
                            </div>
                            <div class="d-help-commet-field">
                                <label>密码</label>
                                <input placeholder="   请输入密码" class="qcord" name="User[pwd]" type="password" value=""autocomplete="off" data-default="Name*" size="30" required>
                                <!--<img src="extra-images/blog-fig.jpg" style="height: 40px; padding-left: 20px">-->
                            </div>
                            <div class="d-help-commet-field">
                                <label>性别</label>
                            ...
                            <div class="d-help-commet-field">
                                <label>手机号</label>
                                <input placeholder="   请输入手机号" name="User[phone]" type="text" value=""autocomplete="off" data-default="Name*" size="30" required>
                            </div>
                            <div class="d-help-commet-field">
                                <label>身份证号码</label>
                                <input placeholder="   请输入身份证号" name="User[id_num]" type="text" value=""autocomplete="off" data-default="Name*" size="30" required>
                            </div>
                            <div class="d-help-commet-field">
                                <label>常住地</label>
                                <select name="User[province]" onchange="chinaChange(this,document.getElementById('city'));" style=" width:40%; height:48px;line-height:48px; ">
                                ...
                                <select name="User[city]" id="city" style=" width:40%; height:48px;line-height:48px; ">
                                    <option value ="未选择">请选择市区</option>
                                </select>
                            </div>
                            <div class="d-help-commet-field">
                                <label>地址详情</label>
                                <input placeholder="   请输入地址详情" name="User[place]" type="text" value=""autocomplete="off" data-default="Name*" size="30" required>
                            </div>
                            <button class="btn-d-help theme-bg-color">注册</button>
                        </form>
                    </div>
                </div>
            </div>
