                ...
                <form class="form form-horizontal" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-12">
                            <input type="text" class="form-control"autocomplete="off" value="{{ old('User')['name']?old('User')['name']:$user->name }}" name="User[name]">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="User[sex]">
                                ...
                                @foreach($user->sex1() as $ind=>$val)
                                    <option value="{{$ind}}" {{ isset($user->sex) && $user->sex==$ind?'selected':'' }}>&nbsp;{{$val}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-12">
                            <input type="text" class="form-control"autocomplete="off" value="{{ old('User')['phone']?old('User')['phone']:$user->phone }}" name="User[phone]">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2">身份证号</label>
                        <div class="col-md-8 col-sm-12">
                            <input type="text" class="form-control"autocomplete="off" value="{{ old('User')['id_num']?old('User')['id_num']:$user->id_num }}" name="User[id_num]">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2">常住地</label>
                        <div class="col-md-8 col-sm-12">
                    ...
                    <br>
                    <div class="form-group">
                        <label class="col-md-2">地址详情</label>
                        <div class="col-md-8 col-sm-12">
                            <input type="text" class="form-control"autocomplete="off" value="{{ old('User')['place']?old('User')['place']:$user->place }}" name="User[place]">
                        </div>
                    </div>
                    <div class="form-footer">
                        <div class="form-group">
                            <div class="col-md-9 col-md-offset-3">
                                <button type="submit" class="btn btn-primary" value="">确定修改</button>
                            </div>
                        </div>
                    </div>
