                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="At[time]" autocomplete="off"  class="form-control" placeholder=" " aria-describedby="basic-addon1" value="{{ old('At')['time']?old('At')['time']:$article->time }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            <div>
                                                @foreach($article->recommend1() as $ind=>$val)
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="At[recommend]" {{ (isset($article->recommend) && $article->recommend==$ind)?'checked':'' }} id="{{$ind}}" value="{{$ind}}" >
                                                        <label for="{{$ind}}">
                                                            {{$val}}
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="col-xs-8">
                                            <div>
                                                @foreach($article->top1() as $ind=>$val)
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="At[top]" {{ (isset($article->top) && $article->top==$ind)?'checked':'' }} id="{{$ind}}" value="{{$ind}}" >
                                                        <label for="{{$ind}}">
                                                            {{$val}}
                                                        </label>
                                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div>
                                                @foreach($article->state1() as $ind=>$val)
                                                    <div class="radio radio-inline">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text"  name="At[abstract]" autocomplete="off" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ old('At')['abstract']?old('At')['abstract']:$article->abstract }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
