                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="At[title]" class="form-control" placeholder="" aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="At[author]" class="form-control" placeholder="" aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                                <input type="text" name="At[typist]" class="form-control" placeholder="" aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="At[time]"  class="form-control" placeholder=" " aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text"  name="At[keywords]"  class="form-control" placeholder="" aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1">
                                                ...
                                                <input type="text"  name="At[abstract]"  class="form-control" placeholder="" aria-describedby="basic-addon1" value=""required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
