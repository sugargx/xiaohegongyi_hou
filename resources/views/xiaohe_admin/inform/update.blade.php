                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="At[title]" autocomplete="off" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ $article->title }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="At[author]" autocomplete="off" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ $article->author }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                                <input type="text" name="At[typist]" autocomplete="off" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ $article->typist }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="At[time]" autocomplete="off"  class="form-control" placeholder=" " aria-describedby="basic-addon1" value="{{ $article->time }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            <div>
                                                @foreach($article->state2() as $ind=>$val)
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="At[state]" {{ isset($article->state) && $article->state==$ind?'checked':'' }} id="{{$ind}}" value="{{$ind}}" >
                                                        <label for="{{$ind}}">
                                                            {{$val}}
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text"  name="At[keywords]" autocomplete="off"  class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ $article->time }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1">
                                                ...
                                                <input type="text"  name="At[abstract]" autocomplete="off"  class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ $article->abstract }}"required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
