                        ...
                        <div class="col-md-12">
                            ...
                            <span class="input-group-addon" id="basic-addon1">
                                <i class="fa fa-tags" aria-hidden="true"></i></span>
                                                <input type="text" name="Nav[name]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ old('Nav')['name']?old('Nav')['name']:$nav->name }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <span class="input-group-addon" id="basic-addon1">
                                                <i class="fa fa-tags" aria-hidden="true"></i></span>
                                                <input type="text" name="Nav[alias]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ old('Nav')['alias']?old('Nav')['alias']:$nav->alias }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            <div>
                                                @foreach($nav->state1() as $ind=>$val)
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="Nav[state]" id="{{$ind}}"{{ isset($nav->state) && $nav->state==$ind?'checked':'' }} value="{{$ind}}" >
                                                        <label for="{{$ind}}">
                                                            {{$val}}
                                                        </label>
                                                    </div>
