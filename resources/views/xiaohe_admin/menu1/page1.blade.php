        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" method="post" action="{{url('save1')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="At[title]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--作者--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="At[author]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--录入--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                            <input type="text" name="At[typist]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--筹款目标--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                            <input type="text" name="At[goal]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--已筹金额--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                            <input type="text" name="At[done]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--捐赠者--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                            <input type="text" name="At[donate]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--链接--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="At[time]"  class="form-control" placeholder=" " aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--推荐--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  name="At[keywords]"  class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--图片--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  name="At[abstract]"  class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--内容--}}
