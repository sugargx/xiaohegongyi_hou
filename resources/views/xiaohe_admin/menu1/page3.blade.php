                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="At[name]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--地址--}}
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <i class="fa fa-square" aria-hidden="true"></i></span>
                                            <input type="text" name="At[place]" class="form-control" placeholder="" aria-describedby="basic-addon1" value="">
                                        </div>
                                    </div>
                                </div>
                                {{--标题--}}
