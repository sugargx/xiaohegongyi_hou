            ...
            <form class="form-horizontal" method="post" action="">
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-8">
                        ...
                        <div class="col-xs-8">
                            <div>
                                <select class="form-control input-md" name="Nav[alias]">
                                    <option value="0">&nbsp;——请选择页面——</option>
                                    @foreach($nav->alias1() as $me)
                                        <option {{ isset($nav->alias) && $nav->alias==$me->id?'selected':'' }} value="{{$me->id}}">&nbsp;{{$me->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <div class="col-xs-8">
                            <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">
                                                <i class="fa fa-tags" aria-hidden="true"></i></span>
                                <input type="text" name="Nav[order1]" autocomplete="off" class="form-control" placeholder="" aria-describedby="basic-addon1" value="{{ old('Nav')['order1']?old('Nav')['order1']:$nav->order1 }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
